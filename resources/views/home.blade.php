        ...
        <div class="banner-top-thumb-wrap">
          <div class="d-lg-flex justify-content-between align-items-center">
            <div class="d-flex justify-content-between  mb-3 mb-lg-0">
              <div>
                <img src="{{ asset('images/dashboard/star-magazine-1.jpg') }}" alt="thumb" class="banner-top-thumb" />
              </div>
            ...
            <div class="d-flex justify-content-between mb-3 mb-lg-0">
              <div>
                <img src="{{ asset('images/dashboard/star-magazine-2.jpg') }}" alt="thumb" class="banner-top-thumb" />
              </div>
              <h5 class="m-0 font-weight-bold">How Hungary produced the</h5>
            </div>
            <div class="d-flex justify-content-between mb-3 mb-lg-0">
              <div>
                <img src="{{ asset('images/dashboard/star-magazine-3.jpg') }}" alt="thumb" class="banner-top-thumb" />
              </div>
              <h5 class="m-0 font-weight-bold">
            ...
            <div class="d-flex justify-content-between mb-3 mb-lg-0">
              <div>
                <img src="{{ asset('images/dashboard/star-magazine-4.jpg') }}" alt="thumb" class="banner-top-thumb" />
              </div>
              <h5 class="m-0 font-weight-bold">
          ...
          <div class="col-lg-4">
            <div class="row">
              <div class="col-sm-6">
                <div class="py-3 border-bottom">
                  <div class="d-flex align-items-center pb-2">
                    <img src="{{ asset('images/dashboard/Profile_1.jpg') }}" class="img-xs img-rounded mr-2" alt="thumb" />
              ...
              <div class="col-sm-6">
                <div class="py-3 border-bottom">
                  <div class="d-flex align-items-center pb-2">
                    <img src="{{ asset('images/dashboard/Profile_2.jpg') }}" class="img-xs img-rounded mr-2" alt="thumb" />
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <div class="pt-3 pb-4 border-bottom">
                  <div class="d-flex align-items-center pb-2">
                    <img src="{{ asset('images/dashboard/Profile_4.jpg') }}" class="img-xs img-rounded mr-2" alt="thumb" />
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="pt-4 pb-4">
                  <div class="d-flex align-items-center pb-2">
                    <img src="{{ asset('images/dashboard/Profile_5.jpg') }}" class="img-xs img-rounded mr-2" alt="thumb" />
              ...
              <div class="col-sm-6">
                <div class="pt-3 pb-4">
                  <div class="d-flex align-items-center pb-2">
                    <img src="{{ asset('images/dashboard/Profile_6.jpg') }}" class="img-xs img-rounded mr-2" alt="thumb" />
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-sm-6 grid-margin mb-5 mb-sm-2">
              <div class="position-relative image-hover">
                <a href="{{ url('/news/'. $news->id) }}"><img src="{{ asset(explode('|', $news->image)[0]) }}" height="300px" class="img-fluid" alt="world-news" /></a>
        ...
        <div class="editors-news">
          ...
          <div class="row">
            <div class="col-lg-6  mb-5 mb-sm-2">
              <div class="position-relative image-hover">
                <img src="{{ asset('images/dashboard/glob.jpg') }}" class="img-fluid" alt="world-news" />
            ...
            <div class="col-lg-6  mb-5 mb-sm-2">
              <div class="row">
                <div class="col-sm-6  mb-5 mb-sm-2">
                  <div class="position-relative image-hover">
                    <img src="{{ asset('images/dashboard/star-magazine-5.jpg') }}" class="img-fluid" alt="world-news" />
                ...
                <div class="col-sm-6  mb-5 mb-sm-2">
                  <div class="position-relative image-hover">
                    <img src="{{ asset('images/dashboard/star-magazine-6.jpg') }}" class="img-fluid" alt="world-news" />
                    <span class="thumb-title">TRAVEL</span>
                  </div>
                  <h5 class="font-weight-600 mt-3">
              ...
              <div class="row mt-3">
                <div class="col-sm-6  mb-5 mb-sm-2">
                  <div class="position-relative image-hover">
                    <img src="{{ asset('images/dashboard/star-magazine-7.jpg') }}" class="img-fluid" alt="world-news" />
                    <span class="thumb-title">POLITICS</span>
                  </div>
                  <h5 class="font-weight-600 mt-3">
                ...
                <div class="col-sm-6">
                  <div class="position-relative image-hover">
                    <img src="{{ asset('images/dashboard/star-magazine-8.jpg') }}" class="img-fluid" alt="world-news" />
                    <span class="thumb-title">TRAVEL</span>
                  </div>
                  <h5 class="font-weight-600 mt-3">
          ...
          <div class="row">
            <div class="col-lg-9">
              <div class="row">
                <div class="col-sm-4  mb-5 mb-sm-2">
                  <div class="position-relative image-hover">
                    <img src="{{ asset('images/dashboard/star-magazine-9.jpg') }}" class="img-fluid" alt="world-news" />
                ...
                <div class="col-sm-4 mb-5 mb-sm-2">
                  <div class="position-relative image-hover">
                    <img src="{{ asset('images/dashboard/star-magazine-10.jpg') }}" class="img-fluid" alt="world-news" />
                ...
                <div class="col-sm-4 mb-5 mb-sm-2">
                  <div class="position-relative image-hover">
                    <img src="{{ asset('images/dashboard/star-magazine-11.jpg') }}" class="img-fluid" alt="world-news" />
              ...
              <div class="row mt-3">
                <div class="col-sm-4 mb-5 mb-sm-2">
                  <div class="position-relative image-hover">
                    <img src="{{ asset('images/dashboard/star-magazine-12.jpg') }}" class="img-fluid" alt="world-news" />
                    <span class="thumb-title">NEWS</span>
                  </div>
                  <h5 class="font-weight-600 mt-3">
                ...
                <div class="col-sm-4 mb-5 mb-sm-2">
                  <div class="position-relative image-hover">
                    <img src="{{ asset('images/dashboard/star-magazine-13.jpg') }}" class="img-fluid" alt="world-news" />
                    <span class="thumb-title">NEWS</span>
                  </div>
                  <h5 class="font-weight-600 mt-3">
                ...
                <div class="col-sm-4 mb-5 mb-sm-2">
                  <div class="position-relative image-hover">
                    <img src="{{ asset('images/dashboard/star-magazine-14.jpg') }}" class="img-fluid" alt="world-news" />
            ...
            <div class="col-lg-3">
              <div class="position-relative mb-3">
                <img src="{{ asset('images/dashboard/star-magazine-15.jpg') }}" class="img-fluid" alt="world-news" />
